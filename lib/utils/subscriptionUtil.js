...
let PL = new SubscriptionType({
	ident: enums.SubscriptionTypeIdent.PL.key,
...
let TA = new SubscriptionType({
	ident: enums.billingEnums.SubscriptionTypeIdent.TA.key,
	name: 'Trial Auction',
	icon: 'fa-flash',
...
let MD = new SubscriptionType({
	ident: enums.billingEnums.SubscriptionTypeIdent.MD.key,
	name: 'Negotiations',
	icon: 'fa-list',
...
let AT = new SubscriptionType({
	ident: enums.billingEnums.SubscriptionTypeIdent.AT.key,
	name: 'Auction Ticket',
	icon: 'fa-ticket',
...
let SL = new SubscriptionType({
	ident: enums.billingEnums.SubscriptionTypeIdent.SL.key,
